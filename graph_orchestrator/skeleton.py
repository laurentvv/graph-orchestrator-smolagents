...
class CompressTransformer(cst.CSTTransformer):
    DESCRIPTION = "Replaces function body with ..."
...
def get_skeleton(raw_code: str, keep_constant: bool = True) -> str:
    """Returns a compressed version of the python code containing only classes and functions signatures."""
    try:
