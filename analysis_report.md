...
**Source** : `logs\run_coding_2026-08-05_221922\run_full.log`
**Date** : 2026-08-05 22:30:00

## 📊 Métriques Globales
- **Durée totale (steps)** : 572.48 s
- **Tokens (Input)** : 202,266
- **Tokens (Output)** : 8,668
...
- **Entités créées** : 0
- **Revendications (Claims)** : 0 (dont 0 'open')
...
| `Coder (fast/multimodal)` | 5 | 572.48 | 202,266 | 8,668 |

## 🚨 Erreurs de Logique / Syntaxe
- **Ligne 756** (Coder (fast/multimodal)) : `InterpreterError: Forbidden access to module: ntpath`
